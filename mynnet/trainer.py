    ...
    def run(self):
        ...
        for epoch in range(self.Epochs):
            ...
            if self.ValidateSamples is None:
                self.validate(samples, tloss, terror)
...
class ReportThread(Thread):
    ...
    def makeJSON(self, data):
        lst = [
            { "samples":s, "tloss":tl, "terror":te, "vloss":vl, "verror":ve } 
    ...
    def home(self, environ, start_response):
        ...
        return [self.HomeHTML % {"json_data":self.json_data()}]
