...
class Model(SaveModelMixin, object):
    ...
    def train(self, x, y_, eta, normalize_grads = False, recompute = True, reset_state = True):
        ...
        self.Out.backprop(grad, step_id)
        gx = [inp.gX[0] for inp in self.Inputs]
        self.GX = gx
    ...
    def check_gradients(self, X = None, Y_ = None, check_params = True, check_inputs = True, mb_size=2,
