...
class LSTM(Layer):
    ...
    def backward(self, dY_in, dchn = None, cache=None): 
...
#
    ...
    def fprop(self, x, in_state):
        ...
        y, out_state = self.step(x, in_state)
        if self.LastRowOnly:
            y = y[:,-1,:]
        return y, out_state
    ...
    def bprop(self, x, state_in, y, state_out, gy, gState):
        ...
        dx, dw, gState = self.backward(gy.transpose((1,0,2)), gState)
        gx = dx.transpose((1,0,2))
        return [gx], gState, [dw/mb]
#
